...
<div class="ty-control-group">
    <label for="dsc_name_{$obj_prefix}{$obj_id}" class="ty-control-group__title cm-required cm-trim">{__("your_name")}</label>
...
<div class="ty-control-group">
    <label for="dsc_message_{$obj_prefix}{$obj_id}" class="ty-control-group__title cm-required cm-trim">{__("your_message")}</label>
