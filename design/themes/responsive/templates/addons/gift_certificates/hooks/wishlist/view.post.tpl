    ...
    <div class="ty-gift-certificate-wishlist ty-column{$columns}">
            ...
            <div class="ty-grid-list__item ty-quick-view-button__wrapper">
                <div class="ty-twishlist-item">
                    <a href="{"gift_certificates.wishlist_delete?gift_cert_wishlist_id=`$gift_key`"|fn_url}" class="cm-post ty-twishlist-item__remove ty-remove" title="{__("remove")}">{include_ext file="common/icon.tpl" class="ty-icon-cancel-circle ty-remove__icon"}<span class="ty-remove__txt ty-twishlist-item__txt">{__("remove")}</span></a>
                </div>
                    ...
                    <div class="ty-product-block__left">
                        ...
                        <div class="clearfix">
                            ...
                            {foreach from=$extra_products item="_product" key="key_cert_prod"}
                                ...
                                <input type="hidden" name="gift_cert_data[products][{$key_cert_prod}][amount]" value="{$wishlist.products.$key_cert_prod.amount}" class="cm-value-decimal" />
