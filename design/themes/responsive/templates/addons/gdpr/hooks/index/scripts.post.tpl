<script>
    (function (_, $) {
        _.tr({
            ...
            "gdpr.site_functionality_cookies_title": '{__("gdpr.site_functionality_cookies_title", ['skip_live_editor' => true])|escape:"javascript"}',
            "gdpr.site_functionality_cookies_description": '{__("gdpr.site_functionality_cookies_description", ['skip_live_editor' => true])|escape:"javascript"}',
        });
    })(Tygh, Tygh.$);
</script>
