{if !$order_status_descr}
    ...
    {assign var="order_status_descr" value=$status_type|fn_get_simple_statuses:true:true}
{/if}
...
{elseif $display == "checkboxes"}
    <div class="ty-status-info">
        {html_checkboxes name=$name options=$order_status_descr selected=$status columns=4 class=$checkboxes_meta}
    </div>
{/if}
{/strip}
