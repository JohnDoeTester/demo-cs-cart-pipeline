...
{$amount = $amount|default:$smarty.session.cart.amount}
{$display_subtotal = $display_subtotal|default:$smarty.session.cart.display_subtotal}
...
{capture name="buttons"}
    ...
    {else}
        {include
            ...
            but_href=$proceed_to_checkout_href
