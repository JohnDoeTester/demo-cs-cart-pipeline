...
<form action="{$smarty.request.extra|to_relative_url|fn_url}" data-ca-result-id="{$smarty.request.data_id}" method="post" name="pages_form">
    ...
    <div class="buttons-container">
        ...
        {else}
            ...
            {$but_text = $button_names.but_text|default:__("add_pages")}
        {/if}
