...
<div class="cm-tabs-content" id="tabs_content_{$id}">
    <div id="content_tab_details_{$id}">
        ...
        <div class="control-group ">
            ...
            <div class="controls">
                <input type="text" name="product_file[file_name]" id="elm_file_name_{$id}" value="{$product_file.file_name}" class="input-large" />
            </div>
        </div>
        ...
        <div class="control-group ">
            <label class="control-label" for="type_{"file_preview[`$id`]"|md5}">{__("preview_file")}</label>
            <div class="controls">
        ...
        <div class="control-group ">
            ...
            <div class="controls">
                <textarea id="elm_file_license_{$id}" name="product_file[license]" cols="55" rows="8" class="cm-wysiwyg input-textarea-long">{$product_file.license}</textarea>
            </div>
        </div>
        ...
        <div class="control-group ">
            ...
            <div class="controls">
                <textarea id="elm_file_readme_{$id}" name="product_file[readme]" cols="55" rows="8" class="cm-wysiwyg input-textarea-long">{$product_file.readme}</textarea>
            </div>
        </div>
