...
<div class="adv-search">
    <div class="group">
        <form action="{""|fn_url}" name="ebay_category_search_form" method="get" class="cm-disable-empty-all cm-ajax">
...
<form action="{$smarty.request.extra|to_relative_url|fn_url}" data-ca-result-id="{$smarty.request.data_id}" method="post" name="categories_form">
